...
if (isset($checkConnect['status']) and $checkConnect['status'] == "true") {		
	...
	if (isset($_SESSION['photo_access']['login']['username'])) {
		...
		if (!empty($_POST["lookup_field"])) {
			...
			if (isset($_SESSION['photo_access']['admin']['user_management']['lookup_field'])) {
				$lookup_field =	$_SESSION['photo_access']['admin']['user_management']['lookup_field'];
			} else {
				$lookup_field = "";
			}
		}
		...
		if (!empty($_POST["lookup_value"])) {
			...
			if (isset($_SESSION['photo_access']['admin']['user_management']['lookup_value'])) {
				$lookup_value =	$_SESSION['photo_access']['admin']['user_management']['lookup_value'];
			} else {
				$lookup_value = "";
			}
		}
		...
		if (!empty($_POST["reset"])) {
			$lookup_field = "";
			$lookup_value = "";
			unset($_SESSION['photo_access']['admin']['user_management']['text_query']);
			unset($_SESSION['photo_access']['admin']['user_management']['lookup_field']);
			unset($_SESSION['photo_access']['admin']['user_management']['lookup_value']);
		}
				...
				if ($lookup_field != "" and $lookup_value != "") {
					...
					if ($lookup_field !== "group_name") {
						...
						if ($lookup_value != "null") {
							...
							if ($lookup_value != "*") {
								//echo "6<br>";
								$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and ".$lookup_field." like '".$lookup_value. "%'";
							} else {
								//echo "8<br>";
								$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and ".$lookup_field." is not NULL";
							}
						} else {
							//echo "9<br>";
							$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and ".$lookup_field." is NULL";
						}
					} else {
						//echo "10<br>";
						$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and b.".$lookup_field." like '".$lookup_value. "%'";
					}
				} else {
					//echo "11<br>";
					$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id";
				}		
			} else {
				//echo "12<br>";
				if ($lookup_field != "" and $lookup_value != "") {
					...
					if ($lookup_field !== "group_name") {
						...
						if ($lookup_value != "null") {
							...
							if ($lookup_value != "*") {
								//echo "16<br>";
								$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and department IN (".$listDepartment.") and user_group_id >=".intval($userGroup)." and ".$lookup_field." like '".$lookup_value. "%'";
							} else {
								//echo "17<br>";
								$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and department IN (".$listDepartment.") and user_group_id >=".intval($userGroup)." and ".$lookup_field." is not NULL";
							}
						} else {
							//echo "18<br>";
							$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and department IN (".$listDepartment.") and user_group_id >=".intval($userGroup)." and ".$lookup_field." is NULL";
						}
					} else {
						//echo "19<br>";
						$text_query = "SELECT a.*, b.group_name FROM `photo_access_users` a, `photo_access_user_group` b where a.user_group_id = b.id and department IN (".$listDepartment.") and user_group_id >=".intval($userGroup)." and b.".$lookup_field." like '".$lookup_value. "%'";
					}
				} else {
					//echo "20<br>";
					$text_query = "SELECT a.*, b.group_name FROM photo_access_users a, photo_access_user_group b where a.user_group_id = b.id and department IN (".$listDepartment.") and user_group_id >=".intval($userGroup);
				}
			}
		} else {
			if (intval($userGroup) == 1) {
		...
		$_SESSION['photo_access']['admin']['user_management']['text_query'] = $text_query;
		$_SESSION['photo_access']['admin']['user_management']['lookup_field'] = $lookup_field;
		$_SESSION['photo_access']['admin']['user_management']['lookup_value'] = $lookup_value;
...
?>
			...
			<div style="width:80%; font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height:18px; border: 0px solid black; margin: 0px auto;background-color:white">
				<br><br>
				<form action="user_management.php" method="post" onsubmit="return checkValidator(this)" name="mainForm">
				<table width=100% style="background-color:white">
					...
					<tr>
						<td colspan=3 style="text-align:center">
							<select name="lookup_field" id="lookup_field">
								<option value=""></option>
								<option value="authentication_method" <?php if ($lookup_field == "authentication_method") echo " selected";?>>Authentication Method</option>
								...
								<?php
								if ($userGroup == 1) {
								echo "<option value=\"department\""; if ($lookup_field == "department") echo " selected"; echo ">Department</option>";
								}
								?>
					...
					<tr>
						<td colspan=2><br>
							<a href="./../edit_user.php" class="newButton"><font color="#ffffff">New User</font></a>
						</td>
					</tr>
					<tr>
						<td>
							<table width=100% style="background-color:white" class="TFtable">
								<tr>
									<td style="padding-left: 1em" width=5%><b>ID</b></td>
									<td width=8%><b>Auth</b></td>
									<td width=10%><b>User ID</b></td>
									<td width=23%><b>User Name</b></td>
								...
								echo "<tr>\n
									<td style=\"padding-left: 1em\">".$outputArray[$row]['id']."</td>\n
									<td>".$outputArray[$row]['authentication_method']."</td>\n
									<td>".$outputArray[$row]['user_id']."</td>\n
									<td>".$outputArray[$row]['first_name']." ".$outputArray[$row]['last_name']."</td>\n
									<td>".$outputArray[$row]['phone']."</td>\n
									<td>".$outputArray[$row]['email']."</td>\n
									<td>".$outputArray[$row]['department']."</td>\n
